<x-app class="text-gray-600">
    <article class="container py-8">
        ...
        <div class="mt-2">The <a href="https://packagist.org/packages/pestphp/pest-plugin-drift" target="_blank" rel="nofollow noopener noreferrer" class="text-indigo-400 underline">pestphp/pest-plugin-drift</a> used under the hood performs a basic conversion, which will help you get started.</div>
