@if ($recommended->isNotEmpty())
    <div {{ $attributes->except('recommended') }}>
        ...
        <ins class="mt-8 adsbygoogle empty:mt-0" style="display:block" data-ad-format="autorelaxed" data-ad-client="ca-pub-3461630254419592" data-ad-slot="4616088468"></ins> <script>(adsbygoogle = window.adsbygoogle || []).push({})</script>
    </div>
@endif
