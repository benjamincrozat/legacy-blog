<aside {{ $attributes->merge(['class' => 'container flex flex-wrap sm:flex-nowrap items-center justify-between gap-4 sm:gap-8 mt-8']) }}>
    ...
    <img src="https://www.gravatar.com/avatar/{{ md5($email) }}?s=192" width="96" height="96" alt="{{ $name }}" class="-translate-y-[.5px] flex-shrink-0 w-16 h-16 sm:w-24 sm:h-24 order-1 sm:order-none rounded-full" />
</aside>
