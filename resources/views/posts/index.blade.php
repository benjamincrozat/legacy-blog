        ...
        <div class="mt-8 sm:mt-16 pb-16">
            <section class="container lg:max-w-screen-md">
                <h2 class="font-bold sm:max-w-screen-xs mx-auto text-xl sm:text-2xl md:text-3xl text-center">
                    ...
                    <span class="block mt-4">Everything I learn about the&nbsp;art&nbsp;of&nbsp;crafting&nbsp;websites, <span class="text-indigo-400">for&nbsp;free</span>!</span>
                </h2>

                <x-form method="POST" action="{{ route('subscribe') }}" class="max-w-screen-xs mx-auto mt-8">
                    <input type="email" name="email" id="email" placeholder="homer@simpson.com" class="bg-gray-700/40 block border-0 placeholder-gray-300 dark:placeholder-gray-600 px-4 py-3 rounded-md shadow w-full" />
