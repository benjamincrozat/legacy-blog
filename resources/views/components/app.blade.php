...
<html lang="{{ app()->getLocale() }}" class="scroll-smooth">
    <head>
        ...
        <link rel="apple-touch-icon" sizes="180x180" href="{{ secure_asset('/img/icons/apple-touch-icon.png') }}" />
        <link rel="icon" type="image/png" sizes="16x16" href="{{ secure_asset('/img/icons/16x16.png') }}" />
        <link rel="icon" type="image/png" sizes="32x32" href="{{ secure_asset('/img/icons/32x32.png') }}" />
        <link rel="icon" type="image/png" sizes="48x48" href="{{ secure_asset('/img/icons/48x48.png') }}" />
        <link rel="icon" type="image/png" sizes="96x96" href="{{ secure_asset('/img/icons/96x96.png') }}" />
