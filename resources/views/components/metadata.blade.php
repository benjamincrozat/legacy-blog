<div {{ $attributes->merge(['class' => 'flex items-center gap-2 text-sm']) }}>
    ...
    <p>
        <a href="https://twitter.com/benjamincrozat" target="_blank" rel="noopener noreferrer" class="border-b border-indigo-200 text-indigo-400" @click="window.fathom?.trackGoal('LNRXVF3B', 0)">Benjamin Crozat</a>
