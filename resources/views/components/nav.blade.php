<div {{ $attributes->merge(['class' => 'flex flex-wrap justify-between gap-8']) }}>
    ...
    <nav class="flex items-center gap-6 sm:gap-8">
        <a
            ...
            class="bg-gradient-to-r from-indigo-300 dark:from-indigo-500 to-indigo-400 dark:to-indigo-600
            font-normal px-3 sm:px-4 py-2 sm:py-3 rounded shadow-md text-white tracking-widest text-xs uppercase"
