    ...
    <footer class="container py-8 text-gray-400 text-sm" x-intersect="window.fathom?.trackGoal('08VVENFW', 0)">
        <div class="flex items-center justify-between">
            ...
            <ul class="flex items-center gap-2 text-gray-300">
                <li>
                    <a href="https://github.com/benjamincrozat" target="_blank" rel="nofollow noopener" @click="window.fathom?.trackGoal('COYELHY0', 0);">
                ...
                <li>
                    <a href="https://www.linkedin.com/in/benjamincrozat" target="_blank" rel="nofollow noopener" @click="window.fathom?.trackGoal('COYELHY0', 0);">
                ...
                <li>
                    <a href="https://twitter.com/benjamincrozat" target="_blank" rel="nofollow noopener" @click="window.fathom?.trackGoal('COYELHY0', 0);">
        ...
        <p class="mt-8 text-center">
            Hosting by <a href="https://m.do.co/c/58bbdf89fc72" target="_blank" rel="nofollow noopener" class="border-b border-gray-700 text-gray-300 hover:text-white transition-colors">DigitalOcean</a>, analytics by <a href="https://usefathom.com/ref/JTPOCN" target="_blank" rel="nofollow noopener" class="border-b border-gray-700 text-gray-300 hover:text-white transition-colors">Fathom&nbsp;Analytics</a> and syntax highlighting by <a href="https://torchlight.dev" target="_blank" rel="nofollow noopener" class="border-b border-gray-700 text-gray-300 hover:text-white transition-colors">Torchlight</a>.
        </p>
