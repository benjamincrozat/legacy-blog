...
>
    ...
    >
        <h2 class="font-bold text-xl sm:text-3xl text-center text-indigo-400">
            ...
            <span class="block mt-4">An expert Laravel developer for your&nbsp;business</span>
        </h2>
    ...
    >
        <h2 class="font-bold text-xl sm:text-3xl text-center text-indigo-400">
            ...
            <div class="block mt-4">My Laravel development services</div>
        </h2>
    ...
    >
        <h2 class="font-bold text-xl sm:text-3xl text-center text-indigo-400">
            ...
            <span class="block mt-4">About me</span>
        </h2>
