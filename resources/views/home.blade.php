...
>
        ...
        <header class="flex flex-wrap md:flex-nowrap items-center md:justify-between gap-8">
            ...
            <div class="flex-shrink-0 order-1 md:order-none text-center md:text-left w-full md:w-auto">
                <img
                    ...
                    class="dark:brightness-75 inline rotate-2 rounded-full"
                />
            </div>
        </header>
    ...
    >
        ...
        <ul class="grid sm:grid-cols-2 gap-12 mt-8 sm:mt-16">
            ...
            <li>
                <svg xml:space="preserve" viewBox="0 0 300.109 300.109" class="fill-current text-indigo-400 w-12 sm:w-16 h-12 sm:h-16">
    ...
    >
        ...
        <div class="flex flex-wrap md:flex-nowrap items-center md:justify-between gap-8 mt-8 sm:text-lg md:text-xl">
            ...
            <div class="flex-shrink-0 order-1 md:order-none text-center md:text-left w-full md:w-auto">
                <img loading="lazy" src="https://www.gravatar.com/avatar/{{ md5('benjamincrozat@me.com') }}?s=256" width="128" height="128" alt="Benjamin Crozat" class="dark:brightness-75 inline rotate-2 rounded-full" />
            </div>
        </div>
    </x-home.section>

    <div class="bg-indigo-500 dark:bg-gray-900 flex-grow">
