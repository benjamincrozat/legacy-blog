...
>
    <div class="bg-indigo-500">
        <div class="container sm:flex sm:items-center sm:justify-between py-8 text-center sm:text-left">
            ...
            <nav class="flex items-center justify-center sm:justify-start gap-8 mt-8 sm:mt-0">
                ...
                <a href="mailto:benjamincrozat@me.com" class="bg-white px-3 py-2 rounded text-indigo-400 text-sm">
                    Contact me!
                </a>
            </nav>
        </div>
    ...
    <div class="bg-gradient-to-r from-indigo-50/50 to-indigo-100/50 text-indigo-900">
        <section class="container max-w-[1024px] py-8 sm:py-16">
            ...
            <div class="grid sm:grid-cols-2 gap-12 sm:gap-8 mt-8 sm:mt-16">
                <div>
                ...
                <div>
                    <svg xml:space="preserve" viewBox="0 0 389.981 389.981" class="fill-current text-indigo-400/75 w-12 sm:w-16 h-12 sm:h-16"><path d="m145.407 248.988-2.775 26.209c-.224 2.115.46 4.225 1.883 5.806 1.422 1.581 3.449 2.483 5.576 2.483h79.301c2.126 0 4.153-.903 5.576-2.483 1.422-1.581 2.106-3.691 1.883-5.806l-2.775-26.209h98.777c15.374 0 27.881-12.507 27.881-27.881V27.881C360.733 12.507 348.225 0 332.852 0H40.63C25.256 0 12.749 12.507 12.749 27.881v193.226c0 15.374 12.507 27.881 27.881 27.881h104.777zm75.648 19.499h-62.629l2.064-19.499h58.5l2.065 19.499zM40.63 15h292.222c7.103 0 12.881 5.778 12.881 12.881V197.99H27.749V27.881C27.749 20.778 33.527 15 40.63 15zM27.749 221.107v-8.117h317.983v8.117c0 7.103-5.778 12.881-12.881 12.881H40.63c-7.103 0-12.881-5.778-12.881-12.881zm304.896 112.769c1.36-2.24 1.453-5.027.244-7.352l-14.813-28.499c-1.291-2.483-3.856-4.041-6.655-4.041H62.061c-2.798 0-5.364 1.558-6.655 4.041l-14.813 28.499c-1.208 2.325-1.116 5.112.244 7.352s3.791 3.607 6.411 3.607h278.986c2.62.001 5.051-1.367 6.411-3.607zM59.599 322.484l7.016-13.499h240.251l7.017 13.499H59.599zm286.134 28.498h-12c-17.368 0-31.499 14.13-31.499 31.499 0 4.142 3.358 7.5 7.5 7.5h59.997c4.142 0 7.5-3.358 7.5-7.5.001-17.368-14.129-31.499-31.498-31.499zm-26.693 23.999c2.735-5.337 8.295-8.999 14.693-8.999h12c6.398 0 11.958 3.662 14.694 8.999H319.04z"/></svg>
