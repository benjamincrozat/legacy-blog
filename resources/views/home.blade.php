...
>
    ...
    >
        <h2 class="font-bold text-xl sm:text-3xl text-center text-indigo-400">
            <svg xml:space="preserve" viewBox="0 0 56 56" class="inline-block fill-current w-12 sm:w-16 h-12 sm:h-16"><path d="M47.533 0H8.467C3.798 0 0 3.798 0 8.467v39.066C0 52.202 3.798 56 8.467 56h39.066C52.202 56 56 52.202 56 47.533V8.467C56 3.798 52.202 0 47.533 0zM54 47.533C54 51.099 51.099 54 47.533 54H8.467C4.901 54 2 51.099 2 47.533V30.414l6.247-6.247C9.038 24.691 9.983 25 11 25s1.962-.309 2.753-.833l10.08 10.08C23.309 35.038 23 35.983 23 37c0 2.757 2.243 5 5 5s5-2.243 5-5c0-1.017-.309-1.962-.833-2.753L46 20.414V27c0 .553.447 1 1 1s1-.447 1-1V17H38c-.553 0-1 .447-1 1s.447 1 1 1h6.586L30.753 32.833C29.962 32.309 29.017 32 28 32s-1.962.309-2.753.833l-10.08-10.08c.524-.791.833-1.736.833-2.753 0-2.757-2.243-5-5-5s-5 2.243-5 5c0 1.017.309 1.962.833 2.753L2 27.586V8.467C2 4.901 4.901 2 8.467 2h39.066C51.099 2 54 4.901 54 8.467v39.066zM11 23c-1.654 0-3-1.346-3-3s1.346-3 3-3 3 1.346 3 3-1.346 3-3 3zm20 14c0 1.654-1.346 3-3 3s-3-1.346-3-3 1.346-3 3-3 3 1.346 3 3z"/></svg>
