...
>
    <div class="container mt-16 lg:max-w-screen-md">
        ...
        <x-prose class="mt-8 md:mt-16 prose-invert prose-a:decoration-[#f471b5]/50 prose-a:text-[#f471b5] prose-a:underline-offset-4">
            <h2>What is Pest?</h2>
            <p><a href="https://pestphp.com" target="_blank" rel="nofollow noopener noreferrer">Pest</a> is a revolutionary testing framework with a focus on simplicity. It's been meticulously designed to bring back the joy of testing in PHP and go even further than what you can do with PHPUnit.</p>
            ...
            <ul>
                ...
                <li>In addition to traditionnal testing, Pest can also help you enforce coding standards thanks to <a href="https://pestphp.com/docs/arch-testing" target="_blank" rel="nofollow noopener noreferrer">its architecture testing helpers</a>. This will faciliate the collaboration with your team.</li>
            </ul>

            <h2>Is this tool enough to migrate my test suite?</h2>
            <p>The <a href="https://packagist.org/packages/pestphp/pest-plugin-drift" target="_blank" rel="nofollow noopener noreferrer">pestphp/pest-plugin-drift</a> used under the hood performs a basic conversion, which will help you get started.</p>
