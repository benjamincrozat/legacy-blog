<x-app>
    <div class="bg-gradient-to-r from-gray-900 to-gray-800 grid place-items-center min-h-screen text-white">
        <div class="container max-w-[1204px]">
            <h1 class="font-semibold mt-10 text-3xl md:text-6xl text-center">
            ...
            <p class="font-semibold mt-4 sm:mt-8 text-xl md:text-2xl text-center">
                <span class="bg-clip-text bg-gradient-to-r from-purple-400 to-purple-300 inline-block">
                    <span class="text-transparent">
                        Escape the ghost town.<br />
                        Create content for humans.
                    </span>
                </span>
            </p>

            <form method="POST" action="#" class="mt-16 text-center">
                @csrf

                <div class="sm:bg-white/10 sm:inline-flex sm:items-center sm:justify-center sm:rounded-full">
                    <input type="email" name="email" id="email" placeholder="homer@simpson.com" required class="border-0 bg-white/10 sm:bg-transparent placeholder-white/30 px-6 py-3 rounded-full sm:rounded-l-full w-full sm:w-auto" />
