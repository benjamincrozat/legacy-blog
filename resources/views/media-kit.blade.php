...
>
    ...
    <div class="container grid gap-16 mt-24 text-xl md:grid-cols-2 place-items-center lg:max-w-screen-md md:mt-32">
        <div>
            ...
            <p class="mt-8 font-bold">
                Pin your logo on my homepage
            </p>

            <p class="text-center">
                <x-button href="#display" class="mt-4 px-3 !py-2 text-sm font-bold bg-blue-600">
                    Learn more
                </x-button>
            </p>
        </div>
        ...
        <div>
            ...
            <p class="text-center">
                <x-button href="#write" class="mt-4 px-3 !py-2 text-sm font-bold bg-blue-600">
                    Learn more
                </x-button>
            </p>
        </div>
    ...
    <x-section id="display" class="container mt-24 scroll-mt-4 md:mt-32 lg:max-w-screen-md">
        <x-slot:title class="text-2xl sm:!text-3xl font-bold text-center">
            Pin your link and logo on my homepage
        </x-slot:title>
    ...
    <div class="container mt-16 text-center md:max-w-screen-sm">
        ...
        <p class="mt-4">
            Simplify your accounting with <a href="https://benjamincrozat.lemonsqueezy.com/checkout/buy/6b81c388-5b8c-4365-815e-de11e6951135?discount=0" class="font-medium underline">yearly payments</a>.
        </p>
    </div>
