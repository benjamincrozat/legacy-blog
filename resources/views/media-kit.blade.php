    ...
    <x-section id="display" class="container mt-24 scroll-mt-4 md:mt-32 lg:max-w-screen-md">
        ...
        <div class="flex items-center justify-between gap-8 mt-8 md:gap-12">
            <div>
                ...
                <p class="mt-2">
                    Even in 2023, <strong class="font-medium text-white">links are more important than ever for Google</strong>. If you are in the software business, getting some from this blog will benefit you.
                </p>
            </div>
