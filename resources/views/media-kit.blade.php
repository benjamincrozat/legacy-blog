...
>
    ...
    <div class="container mt-16 max-w-[320px] md:max-w-[400px] mx-auto md:mt-24">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 916 616">
            ...
            <g fill="none" fill-rule="evenodd"><path stroke="#000" stroke-opacity=".4" d="M8 608h900" /><path stroke="#000" stroke-opacity=".15" d="M908 508H8m0-100h900m0-100H8m0-100h900m0-100H8M908 8H8" /><path stroke="#979797" stroke-linecap="round" stroke-linejoin="round" stroke-width="15" d="m8 608 100-42.180618L208 408l100 100 100 32.564033 100-61.164986L608 508l100-28.600953L808 108 908 8" class="line" /></g>
        </svg>
    </div>
    ...
    <x-section id="display" class="container mt-24 scroll-mt-4 md:mt-32 lg:max-w-screen-md">
        ...
        <div class="flex items-center justify-between gap-8 mt-8 md:gap-12">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" viewBox="0 0 512 512" class="flex-shrink-0 w-16 h-16 md:w-24 md:h-24"><circle cx="283.823" cy="283.824" r="143.032" fill="#e5e7eb"/><path fill="#000" d="M283.823 441.791c-87.104 0-157.967-70.863-157.967-157.967s70.863-157.967 157.967-157.967S441.79 196.72 441.79 283.824s-70.864 157.967-157.967 157.967zm0-286.058c-70.629 0-128.091 57.461-128.091 128.091s57.461 128.091 128.091 128.091 128.091-57.461 128.091-128.091-57.46-128.091-128.091-128.091z"/><path fill="#e5e7eb" d="M283.823 210.506c40.493 0 73.318 32.825 73.318 73.318s-32.825 73.318-73.318 73.318-73.318-32.825-73.318-73.318"/><path fill="#000" d="M283.823 372.079c-48.665 0-88.256-39.59-88.256-88.256 0-8.25 6.688-14.938 14.938-14.938s14.938 6.688 14.938 14.938c0 32.19 26.189 58.38 58.38 58.38s58.38-26.189 58.38-58.38-26.189-58.38-58.38-58.38c-8.25 0-14.938-6.688-14.938-14.938s6.688-14.938 14.938-14.938c48.665 0 88.256 39.59 88.256 88.256s-39.59 88.256-88.256 88.256z"/><path fill="#e5e7eb" d="m107.881 55.068-5.267 47.545-47.546 5.268-40.13-40.129 52.814-52.814z"/><path fill="#000" d="M283.823 55.647c-57.543 0-110.171 21.421-150.353 56.696l-15.219-15.219 4.477-40.412c.499-4.508-1.077-9-4.284-12.207L78.316 4.374c-5.833-5.832-15.292-5.832-21.127 0L4.375 57.189c-5.833 5.833-5.833 15.292 0 21.127l40.128 40.128c2.817 2.816 6.624 4.375 10.563 4.375.547 0 1.096-.03 1.646-.091l40.414-4.477 15.219 15.219c-35.276 40.18-56.698 92.809-56.698 150.353C55.647 409.641 158.006 512 283.823 512c66.164 0 129.001-28.684 172.401-78.697 5.408-6.231 4.738-15.666-1.492-21.073-6.234-5.409-15.667-4.738-21.073 1.492-37.722 43.47-92.334 68.402-149.835 68.402-109.342 0-198.3-88.956-198.3-198.3 0-49.306 18.093-94.463 47.983-129.191L273.73 294.857c2.917 2.916 6.74 4.375 10.563 4.375s7.647-1.459 10.563-4.375c5.833-5.833 5.833-15.292 0-21.127L154.631 133.506c34.73-29.89 79.886-47.983 129.192-47.983 109.344 0 198.3 88.956 198.3 198.3 0 8.25 6.688 14.938 14.938 14.938s14.938-6.688 14.938-14.938C512 158.008 409.64 55.647 283.823 55.647zM36.063 67.752l31.688-31.688 24.492 24.492-3.161 28.529-28.529 3.161-24.49-24.494z"/></svg>
        </div>
    ...
    <div class="container mt-16 text-center md:max-w-screen-sm">
        <a href="https://benjamincrozat.lemonsqueezy.com/checkout/buy/cc173e8e-bafe-48a2-a406-b42b68a7150d" class="inline-block px-4 py-3 text-white transition-opacity bg-orange-400 rounded hover:opacity-75">
