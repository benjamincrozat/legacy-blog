...
>
    ...
    <x-section id="display" class="container mt-24 scroll-mt-4 md:mt-32 lg:max-w-screen-md">
        ...
        <div class="flex items-center justify-between gap-8 mt-8 text-xl md:mt-16 md:gap-12">
            <div>
                <h3 class="font-bold">
    ...
    <x-section id="write" class="container mt-24 scroll-mt-4 md:mt-32 lg:max-w-screen-md">
        ...
        <div class="flex items-center justify-between gap-8 mt-8 text-xl md:mt-16 md:gap-12">
            <div>
                <h3 class="font-bold">
                    Stay on top for of other articles for an entire week
                </h3>
